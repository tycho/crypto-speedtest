...
set terminal pdf dashed size 5.0, 7.07
...
plot "p4-3200-gentoo/mcrypt-rijndael-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Rijndael" with errorlines pt 0 lt 1 lc 1, \
     ...
     "p4-3200-gentoo/mcrypt-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST6" with errorlines pt 0 lt 1 lc 4, \
     "p4-3200-gentoo/mcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo xTEA" with errorlines pt 0 lt 1 lc 5, \
     "p4-3200-gentoo/mcrypt-saferplus-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Safer+" with errorlines pt 0 lt 1 lc 6, \
     "p4-3200-gentoo/mcrypt-loki97-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Loki97" with errorlines pt 0 lt 1 lc 7, \
     "p4-3200-gentoo/mcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Blowfish" with errorlines pt 0 lt 1 lc 8, \
     "p4-3200-gentoo/mcrypt-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo GOST" with errorlines pt 0 lt 1 lc 9, \
     "p4-3200-gentoo/mcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST5" with errorlines pt 0 lt 1 lc 10, \
     "p4-3200-gentoo/mcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo 3DES" with errorlines pt 0 lt 1 lc 11, \
\
     ...
     "p4-3200-debian-etch/mcrypt-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST6" with errorlines pt 0 lt 2 lc 4, \
     "p4-3200-debian-etch/mcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch xTEA" with errorlines pt 0 lt 2 lc 5, \
     "p4-3200-debian-etch/mcrypt-saferplus-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Safer+" with errorlines pt 0 lt 2 lc 6, \
     "p4-3200-debian-etch/mcrypt-loki97-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Loki97" with errorlines pt 0 lt 2 lc 7, \
     "p4-3200-debian-etch/mcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Blowfish" with errorlines pt 0 lt 2 lc 8, \
     "p4-3200-debian-etch/mcrypt-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch GOST" with errorlines pt 0 lt 2 lc 9, \
     "p4-3200-debian-etch/mcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST5" with errorlines pt 0 lt 2 lc 10, \
     "p4-3200-debian-etch/mcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch 3DES" with errorlines pt 0 lt 2 lc 11, \
\
     ...
     "p4-3200-debian-lenny/mcrypt-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST6" with errorlines pt 0 lt 4 lc 4, \
     "p4-3200-debian-lenny/mcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny xTEA" with errorlines pt 0 lt 4 lc 5, \
     "p4-3200-debian-lenny/mcrypt-saferplus-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Safer+" with errorlines pt 0 lt 4 lc 6, \
     "p4-3200-debian-lenny/mcrypt-loki97-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Loki97" with errorlines pt 0 lt 4 lc 7, \
     "p4-3200-debian-lenny/mcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Blowfish" with errorlines pt 0 lt 4 lc 8, \
     "p4-3200-debian-lenny/mcrypt-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny GOST" with errorlines pt 0 lt 4 lc 9, \
     "p4-3200-debian-lenny/mcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST5" with errorlines pt 0 lt 4 lc 10, \
     "p4-3200-debian-lenny/mcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny 3DES" with errorlines pt 0 lt 4 lc 11, \
\
     ...
     "p4-3200-ubuntu-gutsy/mcrypt-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST6" with errorlines pt 0 lt 5 lc 4, \
     "p4-3200-ubuntu-gutsy/mcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy xTEA" with errorlines pt 0 lt 5 lc 5, \
     "p4-3200-ubuntu-gutsy/mcrypt-saferplus-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Safer+" with errorlines pt 0 lt 5 lc 6, \
     "p4-3200-ubuntu-gutsy/mcrypt-loki97-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Loki97" with errorlines pt 0 lt 5 lc 7, \
     "p4-3200-ubuntu-gutsy/mcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Blowfish" with errorlines pt 0 lt 5 lc 8, \
     "p4-3200-ubuntu-gutsy/mcrypt-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy GOST" with errorlines pt 0 lt 5 lc 9, \
     "p4-3200-ubuntu-gutsy/mcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST5" with errorlines pt 0 lt 5 lc 10, \
     "p4-3200-ubuntu-gutsy/mcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy 3DES" with errorlines pt 0 lt 5 lc 11, \
\
     ...
     "p4-3200-fedora8/mcrypt-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST6" with errorlines pt 0 lt 6 lc 4, \
     "p4-3200-fedora8/mcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 xTEA" with errorlines pt 0 lt 6 lc 5, \
     "p4-3200-fedora8/mcrypt-saferplus-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Safer+" with errorlines pt 0 lt 6 lc 6, \
     "p4-3200-fedora8/mcrypt-loki97-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Loki97" with errorlines pt 0 lt 6 lc 7, \
     "p4-3200-fedora8/mcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Blowfish" with errorlines pt 0 lt 6 lc 8, \
     "p4-3200-fedora8/mcrypt-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 GOST" with errorlines pt 0 lt 6 lc 9, \
     "p4-3200-fedora8/mcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST5" with errorlines pt 0 lt 6 lc 10, \
     "p4-3200-fedora8/mcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 3DES" with errorlines pt 0 lt 6 lc 11
...
plot "p4-3200-gentoo/botan-rijndael-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Rijndael" with errorlines pt 0 lt 1 lc 1, \
     ...
     "p4-3200-gentoo/botan-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST6" with errorlines pt 0 lt 1 lc 4, \
     "p4-3200-gentoo/botan-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo GOST" with errorlines pt 0 lt 1 lc 5, \
     "p4-3200-gentoo/botan-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo xTEA" with errorlines pt 0 lt 1 lc 6, \
     "p4-3200-gentoo/botan-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Blowfish" with errorlines pt 0 lt 1 lc 7, \
     "p4-3200-gentoo/botan-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST5" with errorlines pt 0 lt 1 lc 8, \
     "p4-3200-gentoo/botan-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo 3DES" with errorlines pt 0 lt 1 lc 9, \
\
     ...
     "p4-3200-debian-etch/botan-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST6" with errorlines pt 0 lt 2 lc 4, \
     "p4-3200-debian-etch/botan-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch GOST" with errorlines pt 0 lt 2 lc 5, \
     "p4-3200-debian-etch/botan-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch xTEA" with errorlines pt 0 lt 2 lc 6, \
     "p4-3200-debian-etch/botan-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Blowfish" with errorlines pt 0 lt 2 lc 7, \
     "p4-3200-debian-etch/botan-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST5" with errorlines pt 0 lt 2 lc 8, \
     "p4-3200-debian-etch/botan-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch 3DES" with errorlines pt 0 lt 2 lc 9, \
\
     ...
     "p4-3200-debian-lenny/botan-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST6" with errorlines pt 0 lt 4 lc 4, \
     "p4-3200-debian-lenny/botan-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny GOST" with errorlines pt 0 lt 4 lc 5, \
     "p4-3200-debian-lenny/botan-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny xTEA" with errorlines pt 0 lt 4 lc 6, \
     "p4-3200-debian-lenny/botan-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Blowfish" with errorlines pt 0 lt 4 lc 7, \
     "p4-3200-debian-lenny/botan-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST5" with errorlines pt 0 lt 4 lc 8, \
     "p4-3200-debian-lenny/botan-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny 3DES" with errorlines pt 0 lt 4 lc 9, \
\
     ...
     "p4-3200-ubuntu-gutsy/botan-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST6" with errorlines pt 0 lt 5 lc 4, \
     "p4-3200-ubuntu-gutsy/botan-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy GOST" with errorlines pt 0 lt 5 lc 5, \
     "p4-3200-ubuntu-gutsy/botan-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy xTEA" with errorlines pt 0 lt 5 lc 6, \
     "p4-3200-ubuntu-gutsy/botan-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Blowfish" with errorlines pt 0 lt 5 lc 7, \
     "p4-3200-ubuntu-gutsy/botan-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST5" with errorlines pt 0 lt 5 lc 8, \
     "p4-3200-ubuntu-gutsy/botan-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy 3DES" with errorlines pt 0 lt 5 lc 9, \
\
     ...
     "p4-3200-fedora8/botan-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST6" with errorlines pt 0 lt 6 lc 4, \
     "p4-3200-fedora8/botan-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 GOST" with errorlines pt 0 lt 6 lc 5, \
     "p4-3200-fedora8/botan-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 xTEA" with errorlines pt 0 lt 6 lc 6, \
     "p4-3200-fedora8/botan-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Blowfish" with errorlines pt 0 lt 6 lc 7, \
     "p4-3200-fedora8/botan-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST5" with errorlines pt 0 lt 6 lc 8, \
     "p4-3200-fedora8/botan-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 3DES" with errorlines pt 0 lt 6 lc 9
...
plot "p4-3200-gentoo/cryptopp-rijndael-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Rijndael" with errorlines pt 0 lt 1 lc 1, \
     ...
     "p4-3200-gentoo/cryptopp-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST6" with errorlines pt 0 lt 1 lc 4, \
     "p4-3200-gentoo/cryptopp-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo GOST" with errorlines pt 0 lt 1 lc 5, \
     "p4-3200-gentoo/cryptopp-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo xTEA" with errorlines pt 0 lt 1 lc 6, \
     "p4-3200-gentoo/cryptopp-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Blowfish" with errorlines pt 0 lt 1 lc 7, \
     "p4-3200-gentoo/cryptopp-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST5" with errorlines pt 0 lt 1 lc 8, \
     "p4-3200-gentoo/cryptopp-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo 3DES" with errorlines pt 0 lt 1 lc 9, \
\
     ...
     "p4-3200-debian-etch/cryptopp-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST6" with errorlines pt 0 lt 2 lc 4, \
     "p4-3200-debian-etch/cryptopp-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch GOST" with errorlines pt 0 lt 2 lc 5, \
     "p4-3200-debian-etch/cryptopp-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch xTEA" with errorlines pt 0 lt 2 lc 6, \
     "p4-3200-debian-etch/cryptopp-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Blowfish" with errorlines pt 0 lt 2 lc 7, \
     "p4-3200-debian-etch/cryptopp-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST5" with errorlines pt 0 lt 2 lc 8, \
     "p4-3200-debian-etch/cryptopp-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch 3DES" with errorlines pt 0 lt 2 lc 9, \
\
     ...
     "p4-3200-debian-lenny/cryptopp-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST6" with errorlines pt 0 lt 4 lc 4, \
     "p4-3200-debian-lenny/cryptopp-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny GOST" with errorlines pt 0 lt 4 lc 5, \
     "p4-3200-debian-lenny/cryptopp-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny xTEA" with errorlines pt 0 lt 4 lc 6, \
     "p4-3200-debian-lenny/cryptopp-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Blowfish" with errorlines pt 0 lt 4 lc 7, \
     "p4-3200-debian-lenny/cryptopp-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST5" with errorlines pt 0 lt 4 lc 8, \
     "p4-3200-debian-lenny/cryptopp-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny 3DES" with errorlines pt 0 lt 4 lc 9, \
\
     ...
     "p4-3200-ubuntu-gutsy/cryptopp-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST6" with errorlines pt 0 lt 5 lc 4, \
     "p4-3200-ubuntu-gutsy/cryptopp-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy GOST" with errorlines pt 0 lt 5 lc 5, \
     "p4-3200-ubuntu-gutsy/cryptopp-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy xTEA" with errorlines pt 0 lt 5 lc 6, \
     "p4-3200-ubuntu-gutsy/cryptopp-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Blowfish" with errorlines pt 0 lt 5 lc 7, \
     "p4-3200-ubuntu-gutsy/cryptopp-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST5" with errorlines pt 0 lt 5 lc 8, \
     "p4-3200-ubuntu-gutsy/cryptopp-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy 3DES" with errorlines pt 0 lt 5 lc 9, \
\
     ...
     "p4-3200-fedora8/cryptopp-cast6-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST6" with errorlines pt 0 lt 6 lc 4, \
     "p4-3200-fedora8/cryptopp-gost-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 GOST" with errorlines pt 0 lt 6 lc 5, \
     "p4-3200-fedora8/cryptopp-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 xTEA" with errorlines pt 0 lt 6 lc 6, \
     "p4-3200-fedora8/cryptopp-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Blowfish" with errorlines pt 0 lt 6 lc 7, \
     "p4-3200-fedora8/cryptopp-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST5" with errorlines pt 0 lt 6 lc 8, \
     "p4-3200-fedora8/cryptopp-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 3DES" with errorlines pt 0 lt 6 lc 9
...
plot "p4-3200-gentoo/openssl-rijndael-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Rijndael" with errorlines pt 0 lt 1 lc 1, \
     "p4-3200-gentoo/openssl-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Blowfish" with errorlines pt 0 lt 1 lc 2, \
     "p4-3200-gentoo/openssl-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST5" with errorlines pt 0 lt 1 lc 3, \
     "p4-3200-gentoo/openssl-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo 3DES" with errorlines pt 0 lt 1 lc 4, \
\
     ...
     "p4-3200-debian-etch/openssl-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Blowfish" with errorlines pt 0 lt 2 lc 2, \
     "p4-3200-debian-etch/openssl-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST5" with errorlines pt 0 lt 2 lc 3, \
     "p4-3200-debian-etch/openssl-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch 3DES" with errorlines pt 0 lt 2 lc 4, \
\
     ...
     "p4-3200-debian-lenny/openssl-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Blowfish" with errorlines pt 0 lt 4 lc 2, \
     "p4-3200-debian-lenny/openssl-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST5" with errorlines pt 0 lt 4 lc 3, \
     "p4-3200-debian-lenny/openssl-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny 3DES" with errorlines pt 0 lt 4 lc 4, \
\
     ...
     "p4-3200-ubuntu-gutsy/openssl-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Blowfish" with errorlines pt 0 lt 5 lc 2, \
     "p4-3200-ubuntu-gutsy/openssl-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST5" with errorlines pt 0 lt 5 lc 3, \
     "p4-3200-ubuntu-gutsy/openssl-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy 3DES" with errorlines pt 0 lt 5 lc 4, \
\
     ...
     "p4-3200-fedora8/openssl-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Blowfish" with errorlines pt 0 lt 6 lc 2, \
     "p4-3200-fedora8/openssl-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST5" with errorlines pt 0 lt 6 lc 3, \
     "p4-3200-fedora8/openssl-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 3DES" with errorlines pt 0 lt 6 lc 4
...
plot "p4-3200-gentoo/tomcrypt-rijndael-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Rijndael" with errorlines pt 0 lt 1 lc 1, \
     ...
     "p4-3200-gentoo/tomcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo xTEA" with errorlines pt 0 lt 1 lc 7, \
     "p4-3200-gentoo/tomcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo Blowfish" with errorlines pt 0 lt 1 lc 8, \
     "p4-3200-gentoo/tomcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo CAST5" with errorlines pt 0 lt 1 lc 9, \
     "p4-3200-gentoo/tomcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Gentoo 3DES" with errorlines pt 0 lt 1 lc 10, \
\
     ...
     "p4-3200-debian-etch/tomcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch xTEA" with errorlines pt 0 lt 2 lc 7, \
     "p4-3200-debian-etch/tomcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch Blowfish" with errorlines pt 0 lt 2 lc 8, \
     "p4-3200-debian-etch/tomcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch CAST5" with errorlines pt 0 lt 2 lc 9, \
     "p4-3200-debian-etch/tomcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Etch 3DES" with errorlines pt 0 lt 2 lc 10, \
\
     ...
     "p4-3200-debian-lenny/tomcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny xTEA" with errorlines pt 0 lt 4 lc 7, \
     "p4-3200-debian-lenny/tomcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny Blowfish" with errorlines pt 0 lt 4 lc 8, \
     "p4-3200-debian-lenny/tomcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny CAST5" with errorlines pt 0 lt 4 lc 9, \
     "p4-3200-debian-lenny/tomcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Debian-Lenny 3DES" with errorlines pt 0 lt 4 lc 10, \
\
     ...
     "p4-3200-ubuntu-gutsy/tomcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy xTEA" with errorlines pt 0 lt 5 lc 7, \
     "p4-3200-ubuntu-gutsy/tomcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy Blowfish" with errorlines pt 0 lt 5 lc 8, \
     "p4-3200-ubuntu-gutsy/tomcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy CAST5" with errorlines pt 0 lt 5 lc 9, \
     "p4-3200-ubuntu-gutsy/tomcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Ubuntu-Gutsy 3DES" with errorlines pt 0 lt 5 lc 10, \
\
     ...
     "p4-3200-fedora8/tomcrypt-xtea-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 xTEA" with errorlines pt 0 lt 6 lc 7, \
     "p4-3200-fedora8/tomcrypt-blowfish-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 Blowfish" with errorlines pt 0 lt 6 lc 8, \
     "p4-3200-fedora8/tomcrypt-cast5-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 CAST5" with errorlines pt 0 lt 6 lc 9, \
     "p4-3200-fedora8/tomcrypt-3des-ecb.txt" index 1 using 1:($2 / 1048576):($3 / 1048576) title "Fedora 8 3DES" with errorlines pt 0 lt 6 lc 10
